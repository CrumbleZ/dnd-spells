...
\usepackage{multirow, tabularx}
	...
	%% Layout and geometry
	\usepackage[paperheight=8.89cm,paperwidth=6.35cm,margin=0.5cm]{geometry} %Make the card the size of an MTG Card
	\usepackage{tikz}
...
\setmainfont[Path = ./../../fonts/,
	UprightFont={mrs_eaves-roman.otf},
	BoldFont={mrs_eaves-bold.otf}]
	{mrs_eaves}
